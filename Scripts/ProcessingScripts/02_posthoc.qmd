...
```{r}
#| label: fig-viz-lazr
#| fig-cap: "Distribution of the Laz.R indicator"
...
```{r}
#| label: fig-viz-longstr
#| fig-cap: "Distribution of the Longstring indicator"
...
```{r}
#| label: fig-viz-md
#| fig-cap: "Distribution of the Mahalanobis distance indicator"
...
```{r}
#| label: fig-viz-irv
#| fig-cap: "Distribution of the intra-individual response variability indicator"
...
```{r}
#| label: tbl-kneedle-cutoffs
#| tbl-cap: "Cut-off points estimated with the Kneedle algorithm"
...
```{r}
#| label: fig-cum-lazr
#| fig-cap: "Cumulative Laz.R curve with the Kneedle cut-off point"
...
```{r}
#| label: fig-cum-longstr
#| fig-cap: "Cumulative Longstring curve with the Kneedle cut-off point"
...
```{r}
#| label: fig-cum-md
#| fig-cap: "Cumulative Mahalanobis distance curve with the Kneedle cut-off point"
...
```{r}
#| label: fig-cum-irv
#| fig-cap: "Cumulative IRV curve with the high and low Kneedle cut-off points"
...
```{r}
#| label: tbl-flags-overview
#| tbl-cap: "Summary of respondents flagged by each C/IER indicator"
...
```{r}
#| label: tbl-decision-scenarios
#| tbl-cap: "Consequences of alternative post-hoc decision rules"
...
```{r}
#| label: tbl-flag-pairwise-overlap
#| tbl-cap: "Pairwise overlap among diagnostic C/IER flags"
...
```{r}
#| label: tbl-lazr-md-intersection
#| tbl-cap: "Intersection of Laz.R and Mahalanobis distance flags"
...
```{r}
#| label: tbl-posthoc-exclusion-patterns
#| tbl-cap: "Evidence combinations among respondents excluded by Plan A"
...
```{r}
#| label: tbl-analysis-sample-summary
#| tbl-cap: "Derivation of the final analysis sample"
