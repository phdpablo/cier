...
## 2. Exclusões procedimentais (Nível 1)
...
## 3. Cálculo dos indicadores C/IER

### 3.1 Definição das funções auxiliares
...
### 3.2 Cálculo dos quatro indicadores
...
## 6. Pontos de corte via algoritmo Kneedle
...
## 8. Exportação do arquivo com flags
...
readr::write_csv2(data_flag, "Data/AnalysisData/data_flag.csv")
